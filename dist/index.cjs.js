...
function ActionDrivenComponent (_a) {
    ...
    return active ? (React__default['default'].createElement("div", { className: "w-guide" },
        ...
        React__default['default'].createElement("div", { ref: refChildren, className: "w-guide-wrap" }, React__default['default'].cloneElement(children, {
            children: (React__default['default'].createElement(React__default['default'].Fragment, null,
                children.props.children,
                React__default['default'].createElement("div", { className: "w-guide-text " + position.join(" ") },
                    ...
                    React__default['default'].createElement("div", { className: "w-guide-container" },
                        ...
                        React__default['default'].createElement("button", { className: "w-guide-skip", onClick: _skip }, "Skip all"))))),
            onClick: function (e) {
                var _a, _b;
...
function TourComponent (_a) {
    ...
    return active ? (React__default['default'].createElement("div", { className: "w-guide" },
        React__default['default'].createElement("div", { className: "w-guide-mark" }),
        React__default['default'].createElement("div", { className: "w-guide-wrap" }, React__default['default'].cloneElement(children, {
            onClick: function () { },
            ref: ref,
            className: children.props.className +
                (" w-guide-tour-arrow " + position.join(" ") + " w-guide-relative"),
        })),
        React__default['default'].createElement("div", { ref: refChildren, className: "w-guide-tour-cp " + position.join(" ") },
            ...
            React__default['default'].createElement("div", { className: "w-guide-tour-step" }, _renderStep && _renderStep.map(function (ele) { return ele; }))))) : (children);
}
